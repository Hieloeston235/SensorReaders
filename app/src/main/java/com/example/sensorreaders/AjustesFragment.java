    ...
    private Integer lastSensorIdShown = null;
        ...
        private void showNotificationSettingsDialog() {
            ...
            setupSeekBarListeners(seekBarGasMax, tvGasMaxValue, " %", 0);
            setupSeekBarListeners(seekBarHumoMax, tvHumoMaxValue, " %", 0);
        ...
        private void loadCurrentNotificationSettings(SeekBar tempMin, SeekBar tempMax, SeekBar humedadMin, SeekBar humedadMax,
            ...
            gasMax.setProgress(prefs.getInt("gas_max", 50));
            humoMax.setProgress(prefs.getInt("humo_max", 30));
        ...
        private void resetToDefaultValues(SeekBar tempMin, SeekBar tempMax, SeekBar humedadMin, SeekBar humedadMax,
            ...
            // Valor por defecto para gas (%)
            gasMax.setProgress(50);

            // Valor por defecto para humo (%)
            humoMax.setProgress(30);
        ...
        public void setlistSensor(){
            ...
            // Observer con validaciones mejoradas para evitar notificaciones duplicadas
            listaSensores.observe(getViewLifecycleOwner(), new Observer<List<Sensor>>() {
                ...
                public void onChanged(List<Sensor> sensors) {
                    ...
                    // Actualizar lastSensorIdShown antes de procesar
